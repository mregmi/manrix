...
/*
 * File: main.c
 * 	This server is used to implement Miscellaneous devices i.e those who does not have
 * their own server. like processor, PCI, USB, Sound.
 * They can later be implemented as seperate process.
 */
