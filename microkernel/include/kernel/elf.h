...
typedef struct{
   ...
   Elf32_Half		e_phentsize;/* size in bytes of one entry in the file’s program header table; */
...
typedef struct{
	...
	Elf32_Addr		p_vaddr;	/* virtual address at which the first byte of the segment resides */
	Elf32_Addr		p_paddr;
